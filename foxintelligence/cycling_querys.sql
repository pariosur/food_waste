...
ELSEIF [merchant_name (copie pour filter)]="ebay" and REGEXP_MATCH([Product Concat], "casco.*(star|nzi|scooter|midland|ventura|acerbis|momo|moto|modular|vintage|integral|jet|shiro|vespa|shark|motocicleta|viper|motorcycle|helmet|marlboro|abatible)")
...
ELSEIF [merchant_name (copie pour filter)]="alibaba" and [ml_category_2]="cycling" and REGEXP_MATCH([Product Concat],  "sudadera")
...
ELSEIF [merchant_name (copie pour filter)]="adidas" and [ml_category_1]="cycling" and REGEXP_MATCH([Product Concat],  "zapatilla\salpha")
	THEN "sports and outdoors_running_shoes_uncategorized"

ELSEIF [merchant_name (copie pour filter)]="decathlon" and [ml_category_1]="cycling" and REGEXP_MATCH([Product Concat],  "zapatillas\sbebe")
